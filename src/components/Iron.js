      ...
      <div className="tile is-ancestor">
        <div className="tile is-parent">
          <article className="tile is-child box">
            ...
            <br></br>
            <h2 className="title" style={{ fontSize: "140%" }}>1番アイアン</h2>
        ...
        <div className="tile is-parent">
          <article className="tile is-child box">
            ...
            <br></br>
            <h2 className="title" style={{ fontSize: "140%" }}>ロングアイアン</h2>
            <div className="content">
        ...
        <div className="tile is-parent">
          <article className="tile is-child box">
            ...
            <br></br>
            <h2 className="title" style={{ fontSize: "140%" }}>ミドルアイアン</h2>
            <div className="content">
              飛距離：90~160ヤード<br></br>
      ...
      <div className="tile is-ancestor">
        <div className="tile is-parent">
          <article className="tile is-child box">
            ...
            <br></br>
            <h2 className="title" style={{ fontSize: "140%" }}>ショートアイアン</h2>
            <div className="content">
              飛距離：70~130ヤード<br></br>
        ...
        <div className="tile is-parent">
          <article className="tile is-child box">
            ...
            <br></br>
            <h2 className="title" style={{ fontSize: "140%" }}>ピッチングウェッジ</h2>
            <div className="content">
              飛距離：60~120ヤード<br></br>
        ...
        <div className="tile is-parent">
          <article className="tile is-child box">
            ...
            <br></br>
            <h2 className="title" style={{ fontSize: "140%" }}>サンドウェッジ</h2>
            <div className="content">
              飛距離：50~80ヤード<br></br>
      ...
      <div className="tile is-ancestor">
        <div className="tile is-parent is-4">
          <article className="tile is-child box">
            ...
            <br></br>
            <h2 className="title" style={{ fontSize: "140%" }}>アプローチウェッジ</h2>
            <div className="content">
              飛距離：60~100ヤード<br></br>
        ...
        <div className="tile is-parent is-4">
          <article className="tile is-child box">
            ...
            <br></br>
            <h2 className="title" style={{ fontSize: "140%" }}>ロブウェッジ</h2>
            <div className="content">
              飛距離：40~70ヤード<br></br>
